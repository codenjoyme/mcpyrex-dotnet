...
- In the comments to the issue, you should indicate that it is extremely important to follow the instructions in the file `./.mcp-dotnet/instructions/main.agent.md` while performing the task.
