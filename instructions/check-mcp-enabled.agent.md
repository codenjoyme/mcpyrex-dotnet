- If there is no MCP enabled - follow instructions in `.mcp-dotnet/instructions/emulate-mcp.agent.md`
  + To verify is MCP enable read the `.vscode/settings.json` every time you start working.
