...
- Always pay attention to how `settings.yaml` is used in other tools. Don't create unnecessary constructs.  
  ...
  + And `dependencies: list of instaled libraries`
  + Only `dotnet add package *` libraries should be added to dependencies.
...
- Also add examples of how to use the new tool in `./.mcp-dotnet/build/test.sh`.