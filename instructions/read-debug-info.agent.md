- When there are some problems you can always read log file to see what's wrong:
  + with MCP server and MCP runner, you can read the `.mcp-dotnet/logs/mcp_server.log`.
