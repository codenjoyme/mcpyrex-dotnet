- To restart the MCP server, you can use the following command:
  + on Windows: `cd "c:\Java\CopipotTraining\hello-langchain\.mcp-dotnet"; taskkill /f /im ".mcp-dotnet.exe" 2>$null; taskkill /f /im "dotnet.exe" 2>$null; Start-Sleep 2; & "..\.dotnet\dotnet.exe" build --verbosity quiet`
